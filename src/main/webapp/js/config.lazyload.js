        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                ...
                },
                {
                    name: 'uiGrid3',
                    files: [
                        'vendor/modules/ng-grid-3.1.1/ui-grid.min.css',
                        'vendor/modules/ng-grid-3.1.1/ui-grid.min.js'
                    ]
                },
                {
                    name: 'ui.select',
                ...
                },
                {
                    ...
                    files: [
                        ...
                        'vendor/modules/angular-file-upload/v1.1.5/angular-file-upload.js'
                    ]
                },
                {
                    name: 'ui.calendar',
