(function (e, n) {
  "use strict";
  var t = 6, o = 4, i = "asc", r = "desc", l = "_ng_field_", a = "_ng_depth_", s = "_ng_hidden_", c = "_ng_column_",
    g = /CUSTOM_FILTERS/g, d = /COL_FIELD/g, u = /DISPLAY_CELL_TEMPLATE/g, f = /EDITABLE_CELL_TEMPLATE/g,
    h = /CELL_EDITABLE_CONDITION/g, p = /<.+>/, m = /(\([^)]*\))?$/, v = /\./g, w = /'/g,
  ...
  var S = function (e, n, o, i) {
    ...
    if (e.enableCellSelection) {
      ...
      var u = e.showSelectionCheckbox ? 1 === r : 0 === r, f = 1 === r || 0 === r,
        h = r === g.length - 1 || r === g.length - 2, p = g.indexOf(e.col) === g.length - 1,
  ...
  var G = function (e, n, o, i, r) {
    ...
    var a = function (e) {
      ...
      if (!l) return !1;
      var a = l.cellFilter.split(":"), c = l.cellFilter ? o(a[0]) : null,
